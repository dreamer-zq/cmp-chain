...
> 注意：你的应用程序需要导入你刚编写的代码。这里导入路径设置为此存储库（`github.com/zhiqiang-bianjie/cmp-chain/`）。如果您是在自己的仓库中进行的前面的操作，则需要更改导入路径（github.com/{.Username}/{.Project.Repo}）。
...
import (
	...
	app "github.com/zhiqiang-bianjie/cmp-chain/"
	nsclient "github.com/zhiqiang-bianjie/cmp-chain/x/nameservice/client"
	nsrest "github.com/zhiqiang-bianjie/cmp-chain/x/nameservice/client/rest"
)
